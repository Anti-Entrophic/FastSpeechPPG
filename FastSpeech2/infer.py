...
def main(args, configs):
    ...
    # Prepare model
    xxx, optimizer = get_model(args, configs, device, train=True)
    ...
    while True:
        ...
        for batchs in loader:
                ...
                postnet_mel_predictions = postnet_mel_predictions[0].permute(1,0)
                postnet_mel_predictions = postnet_mel_predictions.cpu().detach().numpy()
                np.save("/content/infer.npy",postnet_mel_predictions)
                assert 0 
                # Cal Loss
